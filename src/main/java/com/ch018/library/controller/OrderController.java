...
public class OrderController {
	...
	public ModelAndView createOrder(Model model,
			@RequestParam("book") int bookId, @RequestParam("pers") int personId) {
		...
		order.addOrder(o);
		return new ModelAndView("order", "newOrder",
				wish.getWishesByPerson(personId));
	}

	@RequestMapping(value = "/userOrder")
	public ModelAndView showOrder() {
		return new ModelAndView("userOrder", "showOrders",
				order.getOrdersByPersonId(1));
	}
