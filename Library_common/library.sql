...
--
-- Хост: localhost
-- Время создания: Янв 26 2014 г., 16:08
...
INSERT INTO `books` (`id`, `authors`, `available`, `bookcase`, `count`, `description`, `image`, `pages`, `publication`, `rating`, `shelf`, `term`, `title`, `year_public`, `gid`) VALUES
...
(3, 'Fain Y.', 5, 2, 5, 'As one of the most popular software languages for building Web applications, Java is often the first programming language developers learn.', 'http://i31.fastpic.ru/big/2011/1224/c0/ad98f9c71227aa37a7e2fb2c6d4539c0.jpg', 470, 'WILEY', 0, 4, 14, ' Java Programming 24-Hour Trainer', 2011, 2),
(4, 'Craig Walls', 5, 2, 5, 'Spring in Action, Third Edition, is for all Java developers', 'http://i26.fastpic.ru/big/2011/0712/42/5d3223e783805d76392181b12c60e642.jpg', 401, 'Manning', 0, 2, 14, 'Spring in action', 2011, 2),
(5, 'K. Sierra, B. Bates', 5, 2, 5, 'With hundreds of practice questions and hands-on exercises, SCJP Sun Certified Programmer for Java 6 Study Guide covers what you need to know--and shows you how to prepare--for this challenging exam.', 'https://d3hgnfpzeohxco.cloudfront.net/images/bau/97800715/9780071591065/0/0/plain/scjp-sun-certified-programmer-for-java-6-study-guide-exam-310-065.jpg', 890, 'MC Graw Hill', 0, 3, 14, 'SCJP', 2008, 2),
(6, 'M. Deinum & K. Serneels', 5, 1, 5, 'Pro Spring MVC is an in-depth guide to Spring MVC, a modern web framework build on top of the Spring Framework.', 'http://www.apress.com/media/catalog/product/cache/9/image/9df78eab33525d08d6e5fb8d27136e95/A/9/A9781430241553-3d_5.png', 590, 'Apress', 0, 1, 14, 'Pro Spring MVC: with Web Flow', 2011, 2),
(14, 'Joanna Martine Woolfolk', 5, 10, 5, 'Everyone''s favorite astrology book, having sold over 500,000 copies, is now even easier to use with an interactive CD-ROM', 'http://d23a3s5l1qjyz.cloudfront.net/wp-content/uploads/2011/05/astrology-book.jpg', 461, 'Taylor Trade Publishing', 0, 1, 14, 'The Only Astrology Book You''ll Ever Need', 2006, 6),
(15, 'Roger L Tokheim', 2, 6, 2, 'Designed to be used as an introductory text for students new to the electronics field', 'http://i.ebayimg.com/t/Digital-Electronics-Roger-L-Tokheim-1993-Hardcover/00/$T2eC16V,!yEE9s5jFKheBRbsjOE%2BUw~~_35.JPG', 392, 'World', 0, 1, 14, 'Digital Electronics', 1988, 4),
(16, 'J.R.R. Tolkien', 5, 12, 5, 'In a hole in the ground there lived a hobbit...', 'http://d202m5krfqbpi5.cloudfront.net/books/1372847500l/5907.jpg', 365, 'Houghton Mifflin', 0, 1, 14, 'The Hobbit (Middle-Earth Universe)', 2002, 10),
(17, 'Jared Diamond', 8, 14, 8, 'Life isn''t fair--here''s why: Since 1500, Europeans have, for better & worse, called the tune that the world has danced to.', 'http://d202m5krfqbpi5.cloudfront.net/books/1363934734l/1842.jpg', 494, 'W.W. Norton & Company', 0, 2, 14, 'Guns, Germs, and Steel: The Fates of Human Societies', 2005, 1),
(18, 'Clifford A. Pickover', 3, 15, 3, 'Math’s infinite mysteries and beauty unfold in this follow-up to the best-selling The Science Book', 'http://ecx.images-amazon.com/images/I/41PsllMMlCL._SX258_PJlook-inside-v2,TopRight,1,0_SH20_BO1,204,203,200_.jpg', 985, 'The Science Book', 0, 1, 14, 'The Math Book', 2008, 3),
(19, 'Friedrich Nietzsche, Walter Kaufmann', 5, 20, 5, 'Thus Spoke Zarathustra: A Book for All and None Thus is a philosophical novel by German philosopher Friedrich Nietzsche', 'http://d202m5krfqbpi5.cloudfront.net/books/1349449118l/51893.jpg', 327, 'Penguin Books', 0, 2, 14, 'Thus Spoke Zarathustra', 1978, 7),
(20, 'Jon Ronson', 6, 11, 6, 'The Psychopath Test is a fascinating journey through the minds of madness.', 'http://d202m5krfqbpi5.cloudfront.net/books/1307825196l/9378733.jpg', 288, 'Riverhead Hardcover', 0, 2, 14, 'The Psychopath Test: A Journey Through the Madness Industry', 2011, 9);
